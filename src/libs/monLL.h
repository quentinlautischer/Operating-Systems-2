...
void monLL_push(MonChild **node_head, pid_t monPID, pid_t childPID); //pushes a value d onto the monLL
...
void monLL_snoc(MonChild **node_head, pid_t monPID, pid_t childPID); //appends a node
